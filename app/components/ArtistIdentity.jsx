  ...
  return (
    <section className="bg-[#f7f7f5] text-[#1c1c1c]">
      <div className="relative overflow-hidden">
        ...
        <h1 className="absolute inset-0 flex items-center justify-center text-[28vw] md:text-[22vw] font-bold uppercase tracking-tight text-black/5 select-none lg:ps-18">
          Gem
        </h1>
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6  py-28 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          <motion.div
            ...
            className="max-w-xl  lg:mt-11 "
          >
            <h2 className="text-[14vw] sm:text-[9vw] lg:text-[4.2vw]  leading-none uppercase font-bold ">
              Gem
              <br />
